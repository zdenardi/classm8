...
export type AttendanceWhereUniqueInput = Prisma.AtLeast<{
  userId_classId?: Prisma.AttendanceUserIdClassIdCompoundUniqueInput
  AND?: Prisma.AttendanceWhereInput | Prisma.AttendanceWhereInput[]
  OR?: Prisma.AttendanceWhereInput[]
  NOT?: Prisma.AttendanceWhereInput | Prisma.AttendanceWhereInput[]
  userId?: Prisma.IntFilter<"Attendance"> | number
...
export type AttendanceUserIdClassIdCompoundUniqueInput = {
  userId: number
  classId: number
}
...
export type AttendanceOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "classId" | "status" | "createdAt", ExtArgs["result"]["attendance"]>
...
export interface AttendanceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const attendanceWithUserIdOnly = await prisma.attendance.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Attendances and only return the `userId`
   * const attendanceWithUserIdOnly = await prisma.attendance.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Attendances and only return the `userId`
   * const attendanceWithUserIdOnly = await prisma.attendance.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
